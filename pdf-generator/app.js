...
function startDownload() {
    ...
    const fonts = {
        Roboto: {
            normal: '../public/css/fonts/Roboto-Regular.ttf',
            bold: '../public/css/fonts/Roboto-Medium.ttf',
            italics: '../public/css/fonts/Roboto-Italic.ttf',
            bolditalics: '../public/css/fonts/Roboto-MediumItalic.ttf'
        }
    };
    ...
    pdfDoc.pipe(fs.createWriteStream('src/output/document.pdf'));
    pdfDoc.end();
}
